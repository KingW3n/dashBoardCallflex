                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{route('message')}}" data-grecaptcha-action="message" method="POST">
                                        ...
                                        <hr>
                                        <div class="g-recaptcha" data-sitekey="6LeOhJ0cAAAAAN_JbMVIIw8emTLBBxdmw1dqWw0o"></div><br>
                                    </form>
                                    <hr>
                                    <div class="text-center">
